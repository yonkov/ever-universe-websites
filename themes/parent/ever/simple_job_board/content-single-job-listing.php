...
<div class="job-description">
    ...
    <article class="current-position-container row">
        ...
        */
        ...
        <section class="col">
            ...
            <div class="pics">
                <img src="/wp-content/themes/ever/assets/images/career-images/picture2.jpg" alt="" id="pic">
                <div class="row">
                    <img src="/wp-content/themes/ever/assets/images/career-images/picture3.jpg" alt="">
                    <img src="/wp-content/themes/ever/assets/images/career-images/picture4.jpg" alt="">
                </div>
            </div>
        </section>
    </article>
    ...
    <?php echo do_shortcode('[contact-form-7 id="548" title="Contact Form 1" html_class="contact-form col"]'); 
        //echo do_shortcode('[contact-form-7 id="548" title="Contact form 1"]');
    ?>
    </div>
</div>
