...
miniMenu.addEventListener("click", function(e) {
    ...
    if (isHidden) {
        ...
        hiddenMenu.style.transform = `translate(0,-${windowPosition+hiddenMenu.clientHeight+60}px)`;
        isHidden=true;
    }
})
document.addEventListener("click", function(e) {
    ...
    &&![...e.target.classList].includes("m-i")) {
        hiddenMenu.style.transform = `translate(0,-${hiddenMenu.clientHeight*2}px)`;
        isHidden = true
    }
})
