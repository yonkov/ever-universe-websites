...
jQuery(function ($) {
    ...
    var isHidden = true;
    var hiddenMenuHeight = hiddenMenu.clientHeight;
    ...
    miniMenu.addEventListener("click", function (e) {
        ...
        if (isHidden) {
            hiddenMenu.style.transform = "translate(0,100px)";
            isHidden = false;
        } else {
            hiddenMenu.style.transform = `translate(0,-${hiddenMenuHeight * 2}px)`;
            isHidden = true;
        }
    })
...
allPluses.forEach(plus => {
    console.log(plus.parentElement.parentElement.parentElement.childNodes)
    
    let details = [...plus.parentElement.parentElement.parentElement.childNodes][1];
    console.log(details)
    let values = {
        details,
        plus,
...
allCloses.forEach(ex => {
    let details = ex.parentElement.parentElement.parentElement;
    let plus = details.parentElement.querySelector('.plus-arr');
...
jQuery(function ($) {
    ...
    function changeIconsLightMode() {
        /*
         * Replace all project icons and the custom logo
         *
        */
        $('.gh-dets img, .custom-logo').each(function () {
            //get old image url
...
var allMoonBtns = [...document.getElementsByClassName("night-theme-input")];
var allSunBtns = [...document.getElementsByClassName("day-theme-input")];
...
function changeAllThemeBtns() {
    if (e.classList.contains("light-mode")) {
        allSunBtns.forEach(moonBtn => {
            moonBtn.checked = true;
        })
    } else {

        allMoonBtns.forEach(sunBtn => {
            sunBtn.checked = true;
        })
    }
}
...
// our services rotate
// var turnArrows = [...document.getElementsByClassName('turn-card')];
// turnArrows.forEach(arrow => {
//     console.log(arrow.parentElement)
//     var polygons = [...document.getElementsByClassName([...arrow.parentElement.classList][0])];
//    polygons.forEach(p=>{
//     p.addEventListener('click', function (e) {
//         if (!p.parentElement.parentElement.classList.contains('on-over')) {
//               console.log("HERE")
//             p.parentElement.parentElement.classList.remove('on-out');
//             p.parentElement.parentElement.classList.add('on-over');
//         } else if (p.parentElement.parentElement.classList.contains('on-over')) {
//             p.parentElement.parentElement.classList.remove('on-over');
//             p.parentElement.parentElement.classList.add('on-out');
