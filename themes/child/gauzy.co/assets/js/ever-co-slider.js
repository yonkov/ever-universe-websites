...
// Pricing Self Hosted
for (var i = 5; i <= 6; i++) {
  var pricingAllSwiper = new Swiper(`.b-n-offers-container-${i}`, {
    slidesPerView: 1,
...
// Pricing Cloud Based
for (var i = 5; i <= 6; i++) {
  var pricingAllSwiper = new Swiper(`.b-n-offers-container-cloud-${i}`, {
    slidesPerView: 5,
    slideToClickedSlide: true,
...
// Benefit filter buttons slider

var benefitFilterButtons = new Swiper(".benefit-filter-btns", {
  slidesPerView: 3,
  slideToClickedSlide: true,
  breakpoints: {
    1025: {
...
var homeFeaturesSldier = new Swiper(".features-slider-container", {
  slidesPerView: 7,
  navigation: {
	nextEl: '.swiper-button-next',
	prevEl: '.swiper-button-prev',
