...
<nav id="site-navigation" class="menu-1 navbar">
    <div class="ever-container-b navbar-container">
		...
		<?php // Insert menu items through WP admin
           ...
           <div class="switch-field">
                <input type="radio" id="radio-o" name="switch-t" value="night" checked  class="night-theme-input" />
                <label for="radio-o">
                ...
                <input type="radio" id="radio-t" name="switch-t" value="day" class="day-theme-input"/>
                <label for="radio-t">
	...
	<div class="hidden-menu">
		...
		<div class="switch-field row m-i">
            <input type="radio" id="radio-tw" name="switch-tw" value="day" checked class="m-i day-theme-input"/>
				<label for="radio-tw" class="row m-i" >
            ...
            <input type="radio"  id="radio-ow" name="switch-tw" value="night" checked class="m-i night-theme-input"/>
                <label for="radio-ow" class="row dark-label m-i" >
