...
The child theme that powers the "Gauzy" website:
- https://test.gauzy.co

### Theme

The Gauzy theme is a child theme of the Ever theme, WordPress open-source theme that powers The Ever Universe websites.
...
The Gauzy theme is compatible with the following plugins:
...
* The Gauzy theme uses code from the [Scaffold theme](https://wordpress.org/themes/scafold/) by Danny Cooper, lightweight WordPress theme issued under the GPL License.
* The Gauzy theme uses  a lightweight vanilla js open-source slider called [Tiny JS](https://github.com/gfwilliams/tiny-js), issued under MIT License.
